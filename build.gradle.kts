...
dependencies {
    ...
    // testing
    testImplementation(ApplicationDependencies.TestingPlugins.assertjCore)
    testImplementation(ApplicationDependencies.TestingPlugins.jupiterApi)
    testRuntimeOnly(ApplicationDependencies.TestingPlugins.jupiterEngine)
}
